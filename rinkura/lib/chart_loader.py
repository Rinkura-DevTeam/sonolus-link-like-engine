    ...
    for note in chart.notes:
        ...
        match note.type:
            ...
            case NoteType.Hold:
                ...
                entities.append(
                    HoldHeadNote(beat=beat, end_beat=end_beat, l1_raw=l1_raw, r1_raw=r1_raw)
                )
                for tick_beat in tick_beats[:-1]:
                    entities.append(
                        HoldTickNote(beat=tick_beat, l1_raw=l1_raw, r1_raw=r1_raw)
                    )
                entities.append(
                    HoldEndNote(beat=end_beat, l1_raw=l1_raw, r1_raw=r1_raw)
                )
